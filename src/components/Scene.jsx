    ...
    <>
      ...
      <group position={[0, 0, 0]}>
        ...
        <group>
          ...
          {/* Couple A: Legs bent further (1.8 radians) to hang over the edge */}
          <group position={[6.0, 1.6, 11.5]} rotation={[0, Math.PI / 2, 0]}>
            <BlockHumanoid scale={0.9} materialProps={butterProps} poseProps={{ leftLegRotation: [1.8, 0, 0], rightLegRotation: [1.8, 0, 0], position: [-0.2, 0, 0]}} />
            <BlockHumanoid scale={0.88} materialProps={butterProps} poseProps={{ leftLegRotation: [1.8, 0, 0], rightLegRotation: [1.8, 0, 0], position: [0.5, 0, 0]}} />
          </group>
