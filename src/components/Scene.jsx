...
// --- THE FIXED SOLARIUM UNIT (Everything Locked Together) ---
const SolariumUnit = () => {
  return (
    <Float speed={1.5} rotationIntensity={0.2} floatIntensity={0.5}>
      <group position={[14, -1.1, 12]}>
        ...
        {/* The Chair - Positioned relative to the group center [0,0,0] */}
        ...
        {/* The Lamp - Positioned relative to the group center [0,0,0] */}
...
const WalkingToConversationChapter = ({ butterProps }) => {
  ...
  return (
    <group ref={groupRef} position={[7.5, 1.9, 4.0]} rotation={[0, Math.PI, 0]}>
        <BlockHumanoid ref={p1Ref} scale={0.95} materialProps={butterProps} poseProps={{ cane: true, position: [-0.4, 0, 0] }} />
        <group position={[0.4, 0, 0]}>
          <BlockHumanoid ref={p2Ref} isHelper scale={0.95} materialProps={butterProps} />
        </group>
    </group>
  );
};
