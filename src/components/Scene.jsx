    ...
    <>
      ...
      <group position={[0, 0, 0]}>
        ...
        <group>
          ...
          {/* Couple A: Moving them Left (Lower X) and Forward (Lower Z) so they aren't hidden by the front wall pillar */}
          <group position={[8.5, -0.6, 14.5]} rotation={[0, Math.PI / 2, 0]}>
