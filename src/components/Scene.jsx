...
    // --- LOCKED MOBILE CAMERA: FAR LEFT & CLOSE ---
    // Height (Y) dropped to 1.5 to make walls loom and cut tops.
    const mobileHomePos = new THREE.Vector3(-60, 1.5, 28); 
...
    
    // LookAt dropped to 1.8 to frame characters while pushing tops out.
    const mobileLookAt = new THREE.Vector3(12, 1.8, 12); 
...
            <BlockHumanoid scale={0.9} materialProps={butterProps} poseProps={{ Cane: true, rotation: [0, Math.PI / 2, 0], position: [0.3, 0.1, 0] }} />
          </group>
